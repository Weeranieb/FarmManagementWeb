      ...
      <div className='min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-slate-900 flex items-center justify-center p-4'>
        <div className='w-full max-w-md'>
          <div className='bg-white rounded-2xl shadow-2xl p-8 text-center'>
            ...
            <p className='text-sm text-gray-500 mb-6'>{L.noEmail}</p>
            <Link
              to='/login'
    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-900 via-blue-700 to-slate-900 flex items-center justify-center p-4'>
      <div className='w-full max-w-md'>
        ...
        <div className='bg-white rounded-2xl shadow-2xl p-8'>
          ...
          <p className='text-gray-600 text-center mb-6'>{L.description}</p>
        ...
        <p className='text-center text-blue-100 text-sm mt-6'>{C.copyright}</p>
      </div>
    </div>
  )
}
