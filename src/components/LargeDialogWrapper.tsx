...
const StyledDialog = styled(Dialog)<StyledDialogWrapperProps>(({ theme }) => ({
  '& .MuiPaper-root': {
    ...
    width: '100%', // Make the dialog use full width within the maxWidth constraint
  },
}))
...
const LargeDialogWrapper: React.FC<StyledDialogWrapperProps> = ({
  title,
  open,
  onClose,
  handleFormSubmit,
...
export default LargeDialogWrapper
